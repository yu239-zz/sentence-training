function detect_darpa_video_star_cascade(videoname,model_name,thresh_diff,nms_thresh,frame_num)
...
[boxes,all] = cascade_image(imfile, csc_model, csc_model.thresh + thresh_diff, nms_thresh);
	    % showboxes(im, boxes);

...
void write_da(double* arr, int len, const char* filename)
{
    FILE* fp = fopen(filename, "w");
    if(!fp) {
        mexErrMsgTxt("Error saving file.");
    } else {
...
mxArray *resize(const mxArray *mxsrc, const mxArray *mxscale) {
  ...
  //write_da(src, sdims[0]*sdims[1]*sdims[2], "/home/amichaux/workspace/pedro-detector/tests/src.text");
  //write_da(tmp, ddims[0]*sdims[1]*sdims[2], "/home/amichaux/workspace/pedro-detector/tests/tmp.text");
  //write_da(dst, ddims[0]*ddims[1]*ddims[2], "/home/amichaux/workspace/pedro-detector/tests/dst.text");

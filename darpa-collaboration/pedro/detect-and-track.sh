...
matlab -nodesktop -nosplash -r "cd ~/darpa-collaboration/pedro/detector; detect_darpa_video('$1','$2',$3,$4); cd ~/darpa-collaboration/pedro/tracking; viterbi_track_video('$1','$2',$5,$6); exit;"
